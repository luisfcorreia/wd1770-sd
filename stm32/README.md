...
├── wd1770-emu/
│   └── wd1770-emu.ino  - Legacy monolithic sketch (reference only)
├── stm32-implementation.md - Full STM32 context (moved from root)
├── PIN_ASSIGNMENTS.md  - Complete pinout reference
└── HARDWARE.md         - Hardware documentation and BOM

## Shared Reference (root level)

- `datasheet/` — WD1770/WD1772 IC datasheets
- `documentation/` — Timex FDD 3000 / bus interface technical references
- `rp2350b/` — active RP2350B port (separate project)
```
